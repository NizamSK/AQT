        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <div class="container-fluid">
                  <a class="navbar-brand py-0" href="javascript:;"><img src="{{ asset('website/assets/images/logo.png') }}" alt="Logo" class="img-fluid"></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="javascript:;">Series</a>
                      </li>
                      <li class="nav-item">
