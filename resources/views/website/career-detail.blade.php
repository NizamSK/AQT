    ...
    <div class="container">
        ...
        <div class="job-single bg-darkgray py-4 mb-4 mb-lg-5">
            <div class="px-3 px-md-4 px-xl-5">
                ...
                <div class="desc lg fw-medium pe-md-5 mb-3">Business Development: Representative-Executive</div>
                <div class="desc mb-4">
                ...
                <a href="{{route('website.apply.job',['position'=>'Business Development: Representative-Executive'])}}" class="primary-btn">Apply</a>
            </div>
            <hr class="border-white opacity-50 my-4">
            <div class="px-3 px-md-4 px-xl-5 lh2">
                <div class="row">
                    <div class="col-lg-10 col-xl-9">
                        <div class="desc md2 fw-medium mb-3">Business Development:</div>
                        <ul class="ps-4 mb-4">
                        ...
                        <div class="desc md2 fw-medium mb-3">Relationship Management & Growth:</div>
                        <ul class="ps-4 mb-4">
                        ...
                        <div class="desc md2 fw-medium mb-3">MIS and Reporting:</div>
                        <ul class="ps-4 mb-4">
                        ...
                        <div class="desc md2 fw-medium mb-3">Recruitment Criteria:</div>
                        <ul class="ps-4 mb-4">
